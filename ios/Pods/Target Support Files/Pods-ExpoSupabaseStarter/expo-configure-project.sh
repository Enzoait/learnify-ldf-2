...
with_node \
  ...
  --target "/Users/hugokaba/mac/IIM/ReactNative/learnify-ldf-2/ios/Pods/Target Support Files/Pods-ExpoSupabaseStarter/ExpoModulesProvider.swift" \
  --entitlement "/Users/hugokaba/mac/IIM/ReactNative/learnify-ldf-2/ios/ExpoSupabaseStarter/ExpoSupabaseStarter.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-system-ui"
